function [ st_r_shear ] = fn_ww__setup__create_shear_r_st__vec( st_vec, st_v_shear, st_p )
%fn_ww__setup__create_shear_r: Setup return a reduced shear profile struct from st_v_shear
%
...
%
% INPUT
%   st_vec : Vector bits of st_Dn, can be st_Dn actually.
%
% OUTPUT
...
%
% See also
%   fn_ww__setup__create_shear_r_st__fn(),
...
st_r_shear = struct;
st_r_shear.st_v_shear = st_v_shear;

if ( st_p.bp_Uminmax_precalc )    
    % Calculate function U_max, U_min
    [ st_crit ] = fn_ww__util__find_U_min_max__vec( st_vec, st_v_shear, st_p );
