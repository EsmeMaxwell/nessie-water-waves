function [ v_z, a3_DM ] = fn_ww__ext__diffmtrx__WR_chebdif(N, M)
%fn_ww__ext__diffmtrx__WR_chebdif: EXTERNAL Weideman-Reddy DMSUITE chebdif
%
%   function [ v_z, a3_DM ] = fn_ww__ext__diffmtrx__WR_chebdif(N, M)
%
...
%  JACW, May 2003.
    ...
    th = k*pi/(N-1);
     ...
     v_z = sin(pi*[N-1:-2:1-N]'/(2*(N-1))); % Compute Chebyshev points.
