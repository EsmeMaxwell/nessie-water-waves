function fn_ww__sim_shear_prtb__full_powerlaw_profile(  )
%fn_ww__sim_shear_prtb__full_powerlaw_profile: Sim manager to run err-in-shear for powerlaw profile
%
%   fn_ww__sim_shear_prtb__full_powerlaw_profile(  )
%
% Manager function to setup and execute the err-in-shear-profile simulation
% for the 1/7th powerlaw profile
% 
% See also
    ...
    for lp_hs=1:Nhs
        for lp_dh=1:Ndeltah
            for lp_dU=1:NdeltaU
                ...
                s_filename = sprintf( 'data_shear_prtb_powerlaw/shear_prtb_powerlaw__%d_%d_%d_%d', lp_Fr2, lp_hs, lp_dh, lp_dU );
                s_backup_filename = sprintf( 'data_shear_prtb_powerlaw/shear_prtb_powerlaw__data__%d_%d_%d_%d', lp_Fr2, lp_hs, lp_dh, lp_dU );
                ...
                save( 'data_shear_prtb_powerlaw/shear_prtb_powerlaw__param_space', 'st_param_save' );
