function fn_ww__sim_shear_prtb__opt_deltah_exp_profile(  )
%fn_ww__sim_shear_prtb__full_exp_profile: Sim manager to run err-in-shear for exponential profile to find optimal delta h
%
%   fn_ww__sim_shear_prtb__opt_deltah_exp_profile(  )
%
% Manager function to setup and execute the err-in-shear-profile simulation
% for the exponential profile, this time to find optimal delta h.
% 
% See also
    ...
    for lp_hs=1:Nhs
        for lp_dh=1:Ndeltah
            for lp_dU=1:NdeltaU
                ...
                s_backup_filename = sprintf( 'data_shear_prtb_opt_deltah_exp/shear_prtb_exp_opt_deltah__data__%d_%d_%d_%d', lp_Fr2, lp_hs, lp_dh, lp_dU );
                ...
                save( 'data_shear_prtb_opt_deltah_exp/shear_prtb_exp_opt_deltah__param_space', 'st_param_save' );
