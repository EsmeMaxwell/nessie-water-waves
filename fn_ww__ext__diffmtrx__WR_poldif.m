function [ a3_DM ] = fn_ww__ext__diffmtrx__WR_poldif(x, malpha, B)
%fn_ww__ext__diffmtrx__WR_poldif: EXTERNAL Weideman-Reddy DMSUITE poldif
%
%   [ a3_DM ] = fn_ww__ext__diffmtrx__WR_poldif(x, malpha, B)
%
% Wiedeman and Reddy code to generate differentiation matrices (poldif.m).
...
a3_DM(:,:,ell) = D;                                     % Store the current D
end
